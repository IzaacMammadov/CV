...
\begin{document}
	...
	\begin{itemize}[left=0pt]
		...
		\item \textbf{Interests}: Appointed as a Justice of the Peace/Criminal Magistrate. Promoting Free and Open-Source software use and helping people maintain their privacy. Cryptography and Crypto CTF (Capture The Flag) competitions.
	\end{itemize}
\end{document}